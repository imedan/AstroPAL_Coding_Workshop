pro bootstrap_ex_int2,x,y,leftblock,rightblock

  if brange eq !NULL then begin
        print,''
        print,'Input parameters:'
        print,'brange, erange, leftblock, rightblock'
  endif

;listing variables as arguments after the name of the procedure allows
	;you to assign values to the variables on the command line
	;at the same time you run the procedure
