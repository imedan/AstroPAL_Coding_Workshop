...
;the read function reads your input off the command line and assigns that value to
	;the variable specified in the argument
read,' Enter the left starting position ',x
read,' Enter the right starting position ',y
...
read,' Enter amount lower than x ',leftblock
read,' Enter amount higher than y ',rightblock
